...
function addTodo(todoString) { //function will add todos to todoList
    // YOUR CODE HERE
    todoList.push(todoString);
}

function printTodo() { //function will print every todo in todoList
    // YOUR CODE HERE
    let lstSize = todoList.length;
